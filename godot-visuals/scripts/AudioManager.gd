...
func play_sound(sound: AudioStream, bus := "Effects", volume := 1.0, pitch := 1.0, delay := 0.4) -> void:
...
func play_music(sound: AudioStream, bus := "Music", volume := 1.0, pitch := 1.0, auto_play := true, delay := 0.4) -> AudioStreamPlayer:
